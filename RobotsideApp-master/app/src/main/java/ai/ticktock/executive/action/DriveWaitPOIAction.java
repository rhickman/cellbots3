...
/**
 * Drive to point of interest and wait for a time.
 */
public class DriveWaitPOIAction extends DriveActionBase {
    /**
     * Drive to a point of interest and wait.
     */
    private final class DriveWaitPOIActionInstance extends DriveActionBaseInstance {
        /**
         ...
         */
        private DriveWaitPOIActionInstance(ActionGoal goal, ExecutivePlanner.Callback callback) {
            super(goal, callback);
        }
         ...
         * @param controller The controller.
         * @param world The world object itself.
         * @return The time to wait in milliseconds extracted from the goal.
         */
        @Override
    ...
    public ActionInstance onCreateInstance(ActionGoal goal, ExecutivePlanner.Callback callback) {
        return new DriveWaitPOIActionInstance(goal, callback);
    }
}
